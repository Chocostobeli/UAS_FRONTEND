        ...
        <div className="form-container">
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-field">
              ...
              <input
                type="number"
                name="jumlah_ahli_waris_wna" // Sesuaikan nama dengan field di backend
                value={formData.jumlah_ahli_waris_wna}
            ...
            <div className="form-field">
              ...
              <input
                type="text"
                name="nama_ahli_waris_lainnya_wna" // Sesuaikan nama dengan field di backend
                value={formData.nama_ahli_waris_lainnya_wna}
                onChange={handleChange}
              />
            </div>
            ...
            <div className="saksi-grid">
              <div>
                ...
                <input
                  type="text"
                  name="nama_saksi1_wna" // Sesuaikan nama dengan field di backend
                  value={formData.nama_saksi1_wna}
                  onChange={handleChange}
                  required
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  name="nama_saksi2_wna" // Sesuaikan nama dengan field di backend
                  value={formData.nama_saksi2_wna}
                  onChange={handleChange}
                />
              </div>
            </div>
            ...
            <div className="saksi-grid">
              <div>
                ...
                <input
                  type="text"
                  name="nik_saksi1_wna" // Sesuaikan nama dengan field di backend
                  value={formData.nik_saksi1_wna}
                  onChange={handleChange}
                  required
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  name="nik_saksi2_wna" // Sesuaikan nama dengan field di backend
                  value={formData.nik_saksi2_wna}
                  onChange={handleChange}
                />
              </div>
            </div>
            ...
            <div className="saksi-grid">
              <div>
                ...
                <input
                  type="file"
                  name="foto_ktp_saksi1_wna" // Sesuaikan nama dengan field di backend
