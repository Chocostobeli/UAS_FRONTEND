        ...
        <div className="form-container">
          ...
          <form onSubmit={handleFormSubmit}>
            <div className="form-field">
              ...
              <select
                name="opsi_pengiriman_wna" // Sesuaikan nama dengan field di backend
                value={formData.opsi_pengiriman_wna}
            ...
            <div className="form-field">
              ...
              <input
                type="text"
                name="nama_penerima_wna" // Sesuaikan nama dengan field di backend
                value={formData.nama_penerima_wna}
                onChange={handleChange}
                required
              />
            </div>
            ...
            <div className="form-field">
              ...
              <input
                type="text"
                name="nomor_telepon_penerima_wna" // Sesuaikan nama dengan field di backend
                value={formData.nomor_telepon_penerima_wna}
                onChange={handleChange}
                required
              />
            </div>
            ...
            <div className="form-field">
              ...
              <textarea
                name="alamat_pengiriman_wna" // Sesuaikan nama dengan field di backend
                value={formData.alamat_pengiriman_wna}
                onChange={handleChange}
                required={formData.opsi_pengiriman_wna === 'kurir'} // Wajib jika opsi kurir
              />
            </div>
